-- ═══════════════════════════════════════════════════════════════
-- TonKiné au Travail — V2 : Données de référence
-- ✅ Compatible MySQL 8.0+ et MariaDB 10.4+
-- NOTE : pas de table kinesitherapeutes (le kiné est un utilisateur)
-- ═══════════════════════════════════════════════════════════════

-- ────────────────────────────────────────────────────────────
-- EXERCICES DE PAUSE ACTIVE (identiques PostgreSQL)
-- ────────────────────────────────────────────────────────────
...
(
  ...
  'Mobilisation de toute la colonne vertébrale en rythme avec la musique.',
...
(
  'Cat-Cow debout',
  'Version bureau de l''exercice yoga cat-cow. Mobilise toute la colonne vertébrale en 4 minutes.',
  'DOS_LOMBAIRES', 4, '2× / jour', 2, 'yoga',
  '[{"etape":1,"instruction":"Debout, pieds écartés, mains posées sur les genoux légèrement fléchis."},{"etape":2,"instruction":"Inspirez en creusant le dos : ventre vers le bas, tête levée (cow)."},{"etape":3,"instruction":"Expirez en arrondissant le dos : ventre rentré, tête baissée (cat)."},{"etape":4,"instruction":"10 répétitions lentes, en suivant votre respiration."},{"etape":5,"instruction":"Étirez les bras vers le plafond, maintenez 10 secondes."}]',
  'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=225&fit=crop'
),
(
  'Marche active au bureau',
  'La marche reste le meilleur remède contre la sédentarité.',
  'DOS_LOMBAIRES', 5, '1× après chaque alerte 2h', 1, 'marche,gastronomie,social',
  '[{"etape":1,"instruction":"Levez-vous de votre siège et étirez les bras vers le haut."},{"etape":2,"instruction":"Faites 2 tours complets du couloir."},{"etape":3,"instruction":"Redressez le dos, rentrez légèrement le menton en marchant."},{"etape":4,"instruction":"Si possible, montez un escalier aller-retour."},{"etape":5,"instruction":"Profitez-en pour boire un verre d\\'eau."}]',
...
(
  ...
  '[{"etape":1,"instruction":"Tendez le bras droit devant vous, paume vers le haut."},{"etape":2,"instruction":"Avec la main gauche, repoussez doucement les doigts vers le bas."},{"etape":3,"instruction":"Tenez 20 secondes."},{"etape":4,"instruction":"Paume vers le bas : repoussez les doigts vers le haut. Tenez 20 secondes."},{"etape":5,"instruction":"Changez de bras. Répétez 2 fois chaque côté."}]',
  'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&h=225&fit=crop'
),
(
  'Rotation des poignets',
  'Maintien de la souplesse des tendons et des articulations carpales.',
...
(
  'Roulement d''épaules',
  'Décontraction des trapèzes et des deltoïdes.',
  'EPAULES', 3, '3× / jour', 1, 'musique,gastronomie',
  '[{"etape":1,"instruction":"Debout ou assis, bras le long du corps."},{"etape":2,"instruction":"Remontez les deux épaules vers les oreilles, maintenez 2 secondes."},{"etape":3,"instruction":"Faites rouler les épaules vers l\\'arrière en grand cercle. 8 fois."},{"etape":4,"instruction":"Répétez dans le sens inverse (avant). 8 fois."},{"etape":5,"instruction":"Serrez les omoplates 5 secondes, puis relâchez."}]',
...
(
  ...
  'La compression prolongée des hanches en position assise raccourcit les fléchisseurs de hanche.',
  'HANCHES_BASSIN', 5, '1× après chaque 2h', 1, 'yoga,sport',
  '[{"etape":1,"instruction":"Levez-vous et faites un grand pas en avant avec le pied droit."},{"etape":2,"instruction":"Abaissez le genou gauche au sol."},{"etape":3,"instruction":"Poussez les hanches vers l\\'avant jusqu\\'à sentir l\\'étirement."},{"etape":4,"instruction":"Maintenez 30 secondes en respirant normalement."},{"etape":5,"instruction":"Changez de jambe. Répétez 2 fois par côté."}]',
  'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=225&fit=crop'
);
...
(
  ...
  'Programme progressif de 4 semaines pour éliminer les douleurs cervicales chroniques.',
  'NUQUE_CERVICALES', 4,
  'En cas de douleurs irradiantes dans le bras, consultez un kinésithérapeute avant de continuer.'
),
(
  'Protocole lombaire 3 semaines',
  'Programme de rééducation du dos lombaire pour les travailleurs sédentaires.',
  'DOS_LOMBAIRES', 3,
...
(
  ...
  'Programme préventif pour les frappes clavier intensives.',
  'POIGNETS_AVANT_BRAS', 3, NULL
);

-- Étapes protocole cervical
...
-- ────────────────────────────────────────────────────────────
-- ENTREPRISE DÉMO + COMPTES PAR DÉFAUT
-- Mot de passe admin : Admin@TonKine2026
...
-- Admin RH lié à l'entreprise démo
...
VALUES (
    ...
    'Responsable RH',
    'fr',
    (SELECT id FROM entreprises WHERE email_contact = 'rh@acme-cm.com' LIMIT 1)
);
